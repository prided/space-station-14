...
air-alarm-ui-widget-copy = Copiar configuración a dispositivos similares
air-alarm-ui-widget-copy-tooltip = Copia la configuración de este dispositivo a todos los dispositivos de esta pestaña de alarma atmosférica.
...
air-alarm-ui-scrubber-volume-rate-label = Volumen (L)
air-alarm-ui-scrubber-wide-net-label = Red amplia

### Umbrales

air-alarm-ui-sensor-gases = Gases
air-alarm-ui-sensor-thresholds = Límites
air-alarm-ui-thresholds-pressure-title = Límites (kPa)
air-alarm-ui-thresholds-temperature-title = Límites (K)
air-alarm-ui-thresholds-gas-title = Límites (%)
air-alarm-ui-thresholds-upper-bound = Límite superior de emergencia
air-alarm-ui-thresholds-lower-bound = Límite inferior de emergencia
air-alarm-ui-thresholds-upper-warning-bound = Límite superior de advertencia
