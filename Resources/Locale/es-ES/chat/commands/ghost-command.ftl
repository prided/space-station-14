ghost-command-description = Abandonar la vida y convertirte en un fantasma.
ghost-command-help-text =
    El equipo de fantasmas te convierte en un fantasma, y el personaje que jugaste se vuelve catatónico para siempre.
